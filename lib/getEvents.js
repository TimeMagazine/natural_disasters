...
var stateRef = require(__dirname + '/../data/raw/stateRef.json');
var nwsRef = require(__dirname + '/../data/raw/nws-zones.json');
...
fs.readFile(__dirname + '/../data/raw/counties.csv', 'utf8', function (err, data) {
